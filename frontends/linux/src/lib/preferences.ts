...
export const translations = {
  "zh-CN": {
    ...
    welcomeBack: "欢迎回来",
    authIntro:
      "输入名字和密码即可注册或登录。注册后请使用同一个名字登录；密码以 Argon2id 哈希保存。",
    register: "注册",
    login: "登录",
    username: "名字",
  ...
  en: {
    ...
    authIntro:
      "Enter your name and password to register or log in. Use the same name when you return; passwords are stored as Argon2id hashes.",
    register: "Register",
    login: "Log in",
    username: "Name",
